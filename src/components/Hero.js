    ...
    return (
        <section>
            ...
            <div className="w-5/6 sm:w-3/5 lg:w-max absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center px-10 py-5 rounded-lg bg-black bg-opacity-30 backdrop-blur-[3px] text-white text-center">
                ...
                <h2 className="mt-2 text-xl sm:text-3xl font-merriweather-sans !text-white">The leading woodland conservation group</h2>
                <a
                    className="px-10 py-2 border border-white rounded-lg mt-16 sm:mt-8 bg-white bg-opacity-20 text-3xl text-nowrap hover:px-14 focus:px-14 sm:hover:px-20 sm:focus:px-20 hover:bg-opacity-0 focus:bg-opacity-0 transition-all duration-300"
