    ...
    <div className="w-full">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-0 items-center justify-around mt-10">
          ...
          />
          <h2 className="w-5/6 sm:w-1/3">Ancient woodland used to be abundant in the United Kingdom. Today, only <span className="font-bold text-darkGreen1 dark:text-lightGreen1">2.5%</span> of it remains.</h2>
        </div>
        ...
        <h1 className="mt-16 sm:mt-36 text-darkGreen1 dark:text-lightGreen1 text-center">Want To Get Involved?</h1>
        <div className="flex flex-col sm:flex-row items-center justify-evenly mt-5 sm:mt-10 mb-28">
          ...
          <div className="w-5/6 sm:w-64 flex flex-col gap-10 mt-12 sm:mt-0">
            <a
              className="px-10 py-2 border border-darkGreen1 dark:border-lightGreen1 hover:border-darkGreen2 dark:hover:border-lightGreen2 rounded-md bg-darkGreen1 dark:bg-lightGreen1 hover:bg-darkGreen2 dark:hover:bg-lightGreen2 text-3xl text-white text-center transition-colors duration-300"
            ...
            <a
              className="px-10 py-2 border border-darkGreen1 dark:border-lightGreen1 hover:border-darkGreen2 dark:hover:border-lightGreen2 rounded-md text-3xl text-darkGreen1 dark:text-lightGreen1 hover:text-darkGreen2 dark:hover:text-lightGreen2 text-center hover:shadow-[0px_0px_0px_1px_#044412] dark:hover:shadow-[0px_0px_0px_1px_#2B5E36] transition-all duration-300"
