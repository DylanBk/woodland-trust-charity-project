  ...
  return (
    ...
    <div className="w-full">
      ...
      <div className="flex flex-col mt-28">
        <h1 className="text-darkGreen dark:text-lightGreen text-center">What Is The Woodland Trust?</h1>
      ...
      <div className="flex flex-row justify-evenly mt-36">
        ...
        <div className="text-section">
          <div className="flex flex-row gap-1 items-center">
            ...
            <svg className="w-10 fill-black dark:fill-white" viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="text-section">
          <div className="flex flex-row gap-1 items-center">
            <svg className="w-10 fill-black" viewBox="0 0 60 53" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="text-section">
          <div className="flex flex-row gap-1 items-center">
            <svg className="w-10" viewBox="0 0 55 56" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-col">
        <h1 className="text-darkGreen dark:text-lightGreen text-center mt-36">The UK's Ancient Woodland</h1>
        <div className="flex flex-row items-center justify-around mt-10">
          <img
            ...
            alt="#"
          />
          <h2 className="w-1/3">Ancient woodland used to be abundant in the United Kingdom. Today, only 2.5% of it remains.</h2>
        </div>

        <h2 className="mt-36 text-center">What Are Ancient Woodlands?</h2>
        <div className="flex flex-row items-center justify-around mt-10">
          <p className="w-1/3">
        ...
        <h2 className="mt-28 text-center">What Are Ancient Woodlands?</h2>
        <div className="flex flex-row items-center justify-around mt-10">
          <img
            className="w-96"
            src={placeholder}
        ...
        <h1 className="mt-36 text-darkGreen dark:text-lightGreen text-center">Want To Get Involved?</h1>
        <div className="flex flex-row items-center justify-evenly mt-10 mb-28">
          <p className="w-1/3">
          ...
          <div className="w-64 flex flex-col gap-10">
            <a
              className="px-10 py-2 border border-darkGreen dark:border-lightGreen rounded-md bg-darkGreen dark:bg-lightGreen text-3xl text-white text-center"
            ...
            <a
              className="px-10 py-2 border border-darkGreen dark:border-lightGreen rounded-md bg-none dark:bg-lightGreen text-3xl text-darkGreen dark:text-lightGreen text-center"
